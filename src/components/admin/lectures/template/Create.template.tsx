...
export default function CreateTemplate({
  ...
  const cardStyles = {
    ...
    header: "flex flex-row justify-between items-center p-4 border-b border-gray-100",
  ...
  const formStyles = {
    ...
    input: "w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-kw-brown/20",
    select: "w-full",
    ...
    addButton: "bg-kw-brown text-white px-4 py-2 rounded-lg hover:bg-kw-brown/90 transition-colors",
    removeButton: "text-red-500 hover:text-red-600 transition-colors",
    submitButton: "mt-6 w-full bg-kw-brown text-white px-4 py-3 rounded-lg hover:bg-kw-brown/90 transition-colors font-medium",
  };
