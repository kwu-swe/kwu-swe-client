            ...
            {lectures?.map((lecture: Lecture) => (
              <div key={lecture.lectureId} className={tableStyles.row}>
                <div className={cn(tableStyles.col, "flex-[2]")}>                  
                  <h3 className={tableStyles.label}>{lecture.courseResponseDto.courseName}</h3>
                  <p className={tableStyles.value}>{lecture.courseResponseDto.courseNumber}</p>
                </div>
                ...
                <div className={tableStyles.col}>
                  ...
                  <p className={tableStyles.value}>{lecture.semester} {lecture.year}</p>
                </div>
                <div className={tableStyles.col}>
